...
public class EnrollActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CheckBox underG_cb = findViewById(R.id.check_underGra);
        CheckBox postG_cb = findViewById(R.id.check_postGra);
        CheckBox onC_cb = findViewById(R.id.check_onCampus);
        CheckBox online_cb = findViewById(R.id.check_online);


        // Find the list view and text view for displaying courses' information
        ListView listView = findViewById(R.id.list_courseList);
        TextView textView = findViewById(R.id.tx_enrolledCourse);
        ...
        Button buttonSearch = findViewById(R.id.btn_searchCourse);
        ...
        Button buttonEnroll = findViewById(R.id.btn_enrollCourse);
